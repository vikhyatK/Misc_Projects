...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container">
	...
	<div id="about"  class="jumbotron text-center">
		<h1>MobiSoft Software Ltd.</h1>
		<p>We specialize in product development.</p>
	...
	<div id="portfolio" class="container-fluid text-center bg-grey">
		...
		<div class="row text-center">
			<div class="col-sm-4">
				<div class="thumbnail">
					<img src="b1.jpg" alt="Paris" width="400" height="300">
					<p>
						<strong>Paris</strong>
					</p>
			...
			<div class="col-sm-4">
				<div class="thumbnail">
					<img src="b2.jpg" alt="New York" width="400" height="300">
					<p>
			...
			<div class="col-sm-4">
				<div class="thumbnail">
					<img src="b3.jpg" alt="San Francisco" width="400" height="300">
					<p>
